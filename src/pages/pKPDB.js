...
const pkpdb = () => (
  <Layout>
        ...
        <div class="row">
          <div class="col-md-6 align-self-center pb-7">
            <p>
              ...
              <sub>a</sub> values of ionizable residues and isoelectric points
              of proteins provide valuable local and global insights about their
              structure and function. These properties can be estimated with
              reasonably good accuracy using Poisson-Boltzmann and Monte Carlo
              calculations at a considerable computational cost (from some
              minutes to several hours). pKPDB is a database of theoretical p
              <italic style={{ fontStyle: "italic" }}>K</italic>
              <sub>a</sub> values and pIs calculated over protein structures
            ...
            <div class="row mt-7">
              <div class="col-6">
                ...
                <p>
                  Calculated by using PypKa with default parameters (Ɛ = 15) on
                  ~70% of the Protein Data Bank
                </p>
              </div>
              ...
              <div class="col-6">
                ...
                <p>
                  Determined from the theoretical titration curve accounting for
                  the individual pka values of all titrable residues of each
                  protein
                </p>
              </div>
            </div>
        ...
        <div class="row gap-y">
          <div class="col-lg-4">
            <div class="card card-body border text-center">
              <p class="my-5">
                <i class="icon-global lead-8 text-lighter"></i>
              </p>
              ...
              <p>
                <a
                  class="small-3 fw-600"
                  href="https://api.pypka.org/isoelectric.csv.gz"
                >
                  Download <i class="fa fa-angle-right small-5 pl-1"></i>
                </a>
              </p>
            </div>
          </div>
          ...
          <div class="col-lg-4">
            <div class="card card-body border text-center">
              <p class="my-5">
                <i class="icon-scope lead-8 text-lighter"></i>
              </p>
              <h5>
                p<italic style={{ fontStyle: "italic" }}>K</italic>
                <sub>a</sub> values
              ...
              <p>
                <a
                  class="small-3 fw-600"
                  href="https://api.pypka.org/pkas.csv.gz"
                >
                  Download <i class="fa fa-angle-right small-5 pl-1"></i>
                </a>
              </p>
          ...
          <div class="col-lg-4">
            <div class="card card-body border text-center">
              ...
              <p>
                <a
                  class="small-3 fw-600"
                  href="https://api.pypka.org/similarity090.csv.gz"
                >
                  Download <i class="fa fa-angle-right small-5 pl-1"></i>
                </a>
              </p>
    ...
    <section
      class="section text-white py-50"
      style={{
    ...
    >
      <div class="container">
        <header class="section-header">
          ...
          <h2 class="display-3 fw-400">
            Download vs <span class="mark-underline">Query</span>
          </h2>
          <hr />
          <p class="lead-2">
            Are you interested in querying individual proteins by PDB ID instead
            of downloading the full database?
          </p>
        </header>

        <p class="text-center">
          <a class="btn btn-xl btn-round btn-light w-250" href="/run-pypka">
