          ...
          <div className="row h-full">
            <div className="col-12 col-lg-8 offset-lg-2 align-self-center">
              ...
              <p className="fs-20 w-400 mx-auto hidden-sm-down">
                Flexible Poisson-Boltzmann based pK<sub>a</sub> calculations with proton tautomerism
              </p>
              ...
              <Link className="btn btn-xl btn-round btn-white w-200 hidden-sm-down" to="/run-pypka">
                Run PypKa
              </Link>
              <Link className="btn btn-lg btn-round btn-white w-200 hidden-md-up" to="/run-pypka">
                Run PypKa
              </Link>
            </div>
        ...
        <div className="container">
          ...
          <div className="row gap-y">
            <div className="col-12 col-md-6 col-xl-4 feature-1">
              ...
              <p>
                Electrostatic-driven p<em>K</em>
                <sub>a</sub> estimations
              </p>
            </div>
            ...
            <div className="col-12 col-md-6 col-xl-4 feature-1">
              <p className="feature-icon text-warning">
            ...
            <div className="col-12 col-md-6 col-xl-4 feature-1">
              <p className="feature-icon text-danger">
            ...
            <div className="col-12 col-md-6 col-xl-4 feature-1">
              <p className="feature-icon text-success">
        ...
        <div className="container">
          <div className="section-dialog text-center">
            ...
            <p>
              ...
              <br />
              <code>
                Reis <span>et al. J Chem Inf Model.</span> 2020
              </code>
              <br />
              <a href="https://pubs.acs.org/doi/10.1021/acs.jcim.0c00718">
                <code>DOI: 10.1021/acs.jcim.0c00718</code>
              </a>
            </p>
          </div>
        </div>
      ...
      <section className="section pb-0 overflow-hidden hidden-sm-down">
        <div className="container">
          <header className="section-header">
            ...
            <hr />
            <p className="lead">
              Easily calculate p<em>K</em>
              <sub>a</sub> values in your protein of interest with our server.
            </p>
          </header>
          ...
          <div className="row gap-y text-center">
            <div className="col-md-4 d-flex flex-column">
              ...
              <div className="px-20 mt-auto">
                <img
                  className="shadow-4 opacity-80 aos-init aos-animate"
                  src={data.tabfiles.edges[0].node.publicURL}
                  alt="..."
                  data-aos="slide-up"
                  data-aos-delay="300"
                />
            ...
            <div className="col-md-4 d-flex flex-column">
              <div className="mb-7">
                <span className="text-info fs-50">40s</span>
                <br />
                <p>Calculation on a 50 residue Protein</p>
              </div>
              <div className="mt-auto">
                <img
                  className="shadow-6 aos-init aos-animate"
                  src={data.tabfiles.edges[1].node.publicURL}
                  alt="..."
                  data-aos="slide-up"
                />
              </div>
            ...
            <div className="col-md-4 d-flex flex-column">
              <div className="mb-7">
                <span className="text-info fs-50">0.3</span>
                <br />
              ...
              <div className="px-20 mt-auto">
                <img
                  className="shadow-4 opacity-80 aos-init aos-animate"
                  src={data.tabfiles.edges[2].node.publicURL}
                  alt="..."
                  data-aos="slide-up"
                  data-aos-delay="600"
                />
      ...
      <section className="section bg-gray text-center">
        <div className="row">
          <div className="col-12 offset-md-3 col-md-6">
            <p>
              <img src={data.githubimg.edges[0].node.publicURL} alt="..." />
            </p>
            <br />
            <h3 className="fw-900 mb-20">Fork the project on GitHub</h3>
            <p className="lead text-muted">
              Pypka is open source! It's developed and maintained on GitHub so that you can make it
              your own.
            </p>
            <br />
            <a
              className="btn btn-lg btn-round btn-success"
              href="https://github.com/mms-fcul/PypKa"
            >
              View GitHub Project
            </a>
          </div>
